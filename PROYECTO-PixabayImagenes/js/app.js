...
async function buscarImagenes() {
    ...
    const key = '25012441-cf325aaf551ac3a48f90f703d';
            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
                <div class="bg-white">
                    ...
                    <div class="p-4">
                        ...
                        <a class="block font-bold w-full bg-blue-800 hover:bg-blue-500 text-white uppercase text-center rounded mt-5 p-1" href="${largeImageURL}" target="_blank" rel="noopener noreferrer"> Ver Imagen </a>
                    </div>
                </div>
            </div>
        `;
